...
*/
	$tiles = [
		...
		array(
			"title" => "वेबिनार और वीडियो रिलीज",
			"text" => "कोविड-19 प्रबंधन और टीकों पर विशेषज्ञों के साथ चर्चा",
			"link_text" => "वेबिनार और वीडियो रिलीज",
			"endpoint" => "webinar"
		),
		array(
    ...
    array(
		...
		array(
			"title" => "इन्फ़ोग्राफ़िक्स और सूचना स्रोत",
			"text" => "कोविड-19 पर विश्वसनीय जानकारी देने के लिए विकसित इन्फोग्राफिक्स और सूचना स्रोत ",
			"link_text" => "‘इन्फ़ोग्राफ़िक्स और सूचना स्रोत’ पर जाएं",
...
<div class="dashboard-container mt-5 mb-3 pb-5">
  ...
  <div class="container">
    <div class="intro-paragraph p-3 my-3">
      ...
      <p>हम नियमित रूप से इस जानकारी को विस्तार देंगे, बेहतर करेंगे और सूचना को लगातार अपडेट करते रहेंगे। इसलिए यहां बार-बार आएं और इसे बेहतर बनाने के लिए हमें अपनी राय से अवगत भी करवाएं।</p> 
    </div>
    <div class="row">
<!-- Tiles loop -->
